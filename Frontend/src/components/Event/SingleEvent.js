...
const SingleEvent = (props) => {
	const { eventClass, eventID, eventTitre, eventDate, eventPrix, eventPlace,eventPlaceReservee,lieu,description } = props;
	return(
        <div className={eventClass ? eventClass : 'event__card'}>
            <div className="event__card--content">
                <div className="event__card--content-area">
                    ...
                    <div className="event__card--price">
                        {eventPlace ? eventPlace : 'Free'}
                    </div>
                    <div className="event__card--price">
                        {eventPlaceReservee ? eventPlaceReservee : 'Free'}
                    </div>
                </div>
